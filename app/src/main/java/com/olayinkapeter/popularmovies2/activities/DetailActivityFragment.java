package com.olayinkapeter.popularmovies2.activities;
...
import com.olayinkapeter.popularmovies2.AsyncTasks.CheckFavourite;
import com.olayinkapeter.popularmovies2.AsyncTasks.DeleteFavourite;
import butterknife.Bind;
import butterknife.ButterKnife;
import com.olayinkapeter.popularmovies2.moviemodel.AllReviews;
import com.olayinkapeter.popularmovies2.moviemodel.AllTrailers;
 ...
 * Placeholder fragment which contains a view
 */
public class DetailActivityFragment extends Fragment implements View.OnClickListener{
    ...
    private MovieService.TheMovieDBApi tmdbApi;
    ...
    public static final String MOVIE_SHARE_HASHTAG = "#OtunbaPopularMoviesAppMasterUdacityNanodegree";
    ...
    @Bind(R.id.trailers_heading_textview)
    ...
    @Bind(R.id.moviePoster_image)
    ImageView smallPosterView;
    @Bind(R.id.movie_overview_textView)
    TextView movieOverviewTextview;
    @Bind(R.id.movieName_textView)
    TextView movieTitleTextView;
    @Bind(R.id.movieYear_textView)
...
/*
    ...
    /**Share Intent to create a share action in AppBar/Toolbar   **/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tmdbApi = retrofit.create(MovieService.TheMovieDBApi.class);

        // Used to set The star for Favorite status

        try {
            CheckFavourite isFavoriteTask = new CheckFavourite(getContext(), rootView);
        ...
        favButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DeleteFavourite delfavorites = new DeleteFavourite(getContext(), rootView);
                delfavorites.execute(movie);
    ...
    private void addReviews(List<AllReviews.MovieReview> reviews) {
        ...
        for (AllReviews.MovieReview review : reviews) {
            ViewGroup reviewContainer = (ViewGroup) inflater.inflate(R.layout.review_item, mReviewsView,
                    false);
